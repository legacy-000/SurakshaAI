...
const SCREEN_LABELS: Record<string, string> = {
  ...
  work: "Work a Case", network: "Criminal Network", profiling: "Offender Profiling",
  financial: "Financial Crime", victims: "Victim Analysis",
  patterns: "Patterns & Trends", socio: "Socio Insights", forecasting: "Forecasting",
  alerts: "Alerts", audit: "Audit Trail",
};

const ALL_SCREENS = ["dashboard", "chat", "cases", "work", "network", "profiling", "financial",
  "victims", "patterns", "socio", "forecasting", "alerts", "audit"];
