...
ROLE_PERMISSIONS = {
    "Investigator": {
        "actions": ["chat_query", "view_offender", "view_network", "export_pdf",
                    ...
                    "get_hotspots", "get_socio_demographics", "get_network", "get_dashboard_kpis", "get_alerts",
                    "get_trends", "get_forecast", "get_offender_profile", "create_offender_profile",
                    "network_ai_query", "network_list_conversations", "network_get_conversation",
    ...
    "Policymaker": {
        "actions": ["view_trends", "view_forecast", "export_pdf", "chat_query",
                    "get_hotspots", "get_socio_demographics", "get_network", "get_dashboard_kpis", "get_alerts",
                    "get_trends", "get_forecast", "get_offender_profile",
                    "network_ai_query", "network_list_conversations", "network_get_conversation",
                    "network_create_conversation", "network_delete_conversation"],
