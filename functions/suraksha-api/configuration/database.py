...
# Compatibility shim: provide get_db for legacy route imports
# Routes inject a mock SQLAlchemy Session that works offline
from typing import Generator
from .mock_session import MockSession


def get_db() -> Generator[MockSession, None, None]:
    """Yield a mock DB session for compatibility with existing SQLAlchemy code."""
    yield MockSession()
